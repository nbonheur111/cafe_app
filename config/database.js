...
let connectionString = `mongodb+srv://${process.env.MONGOUSERNAME}:${process.env.MONGOPASSWORD}@mongosetupcluster.ulvph39.mongodb.net/CafeData?retryWrites=true&w=majority`;
